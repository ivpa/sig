        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <!-- InstanceBeginEditable name="EditRegion3" --><!-- Content Header (Page header) -->
                <section class="content-header">
                	<h1>Reportes de Venta Totales por Cliente</h1>
                    <ol class="breadcrumb">
                        <li><a href="index_estrategico.php"><i class="fa fa-home"></i>Inicio</a></li>
                        <li class="active">Reportes de Venta Totales por Cliente</li>
                    </ol>
				</section>
			...
			$resul = false;
				...
				if ($resul == true){
					...
					//Si el reporte no es null
							if ($reporte_ventaCliente['Cliente']==null) {
								$flag=0;
							}
	
							if ($flag!=0){
								  $sql_excel="SELECT * FROM venta_cliente WHERE FechaInicial='".$fechain."'  AND FechaFinal= ' ".$fechafn."'";
				?>					
					<!--<div class="box">-->
					<div class="box" id="tabla">
						<div class="box-header">	
                            <h3 class="box-title">Ventas Totales por Cliente</h3>                          
                        </div>
                        <div class="box-body table-responsive" id="respuesta">
                            <table id="example1" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    <?php do { ?>
                                        <tr>
											<td><?php  echo $reporte_ventaCliente['Cliente']; ?></td>
                                            <td><?php echo $reporte_ventaCliente['Agencia']; ?></td>
											<td><?php echo $reporte_ventaCliente['TotalVentas']; ?></td>
                                        </tr>
                                    <?php } while ($reporte_ventaCliente=sqlsrv_fetch_array($result));?>
                                </tbody>
                                <tfoot>
                                    <tr>
                                        <th>Cliente</th>
